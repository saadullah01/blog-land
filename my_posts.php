...
<body>
  ...
  $recent_posts = "SELECT * FROM post WHERE person_id = '$user_id' ORDER BY id DESC";
  $store = $conn->query($recent_posts);
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="description" value="<?php echo $col["id"]; ?>">
                  <?php
                  echo substr($col["textarea"], 0, 310);
                  $x++;
                  ?>
                  &nbsp; <a href="specificpost.php?edit=<?php echo $col["id"]; ?>&&cat_id=<?php echo $col["category_id"]; ?>">read more...</a> 
                </div>
              </div>
            </div>
          </div>
